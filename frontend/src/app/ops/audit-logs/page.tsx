            ...
            columns={[
              {
                ...
                header: "日時",
                render: (row) => (
                  <span className="small text-body-secondary text-nowrap">{formatDateTime(row.created_at)}</span>
                ),
              },
              {
                key: "action",
                header: "アクション",
                render: (row) => <span className="badge bg-dark">{formatAction(row.action)}</span>,
              },
              {
                key: "actor",
                header: "アクター",
              ...
              },
              {
                ...
                header: "対象",
                render: (row) => (
                  <span className="small">{row.target_type ? `${row.target_type} #${row.target_id}` : "-"}</span>
                ),
              },
              {
                key: "detail",
                header: "詳細",
                render: (row) => <span className="small text-body-secondary">{formatDetail(row)}</span>,
              },
            ]}
          />
