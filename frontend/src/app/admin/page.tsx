...
export default function AdminPage() {
  const [tab, setTab] = useState<Tab>("classTypes");
  ...
  return (
    <div style={{ padding: "24px", fontFamily: "system-ui, sans-serif", maxWidth: "1100px", margin: "0 auto" }}>
      <h1 style={{ fontSize: "22px", fontWeight: 700, marginBottom: "4px" }}>Admin / スタッフ管理</h1>
      <p style={{ fontSize: "13px", color: "#6b7280", marginBottom: "16px" }}>
        <a href="/" style={{ color: "#3b82f6" }}>← カレンダーに戻る</a>
      </p>
